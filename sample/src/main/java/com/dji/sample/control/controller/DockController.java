 ...
 * 도크 제어 컨트롤러 클래스
 */
@Tag(name = "[Control] 도크 제어", description = "도크(Dock) 디바이스의 비행, 페이로드, 원격 디버깅 등을 제어하는 API")
...
public class DockController {
    ...
    @Operation(summary = "원격 디버깅 작업 생성",
