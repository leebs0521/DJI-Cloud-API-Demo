...
public class MediaController implements IHttpMediaService {
     ...
     */
    @Override
    public HttpResultResponse mediaFastUpload(
            String workspaceId,
            @Valid MediaFastUploadRequest request,
    ...
    public HttpResultResponse<String> mediaUploadCallback(
            String workspaceId,
            @Valid MediaUploadCallbackRequest request,
            HttpServletRequest req, HttpServletResponse rsp
    ) {
     ...
     */
    @Override
    public HttpResultResponse<GetFileFingerprintResponse> getExistFileTinyFingerprint(
            String workspaceId,
            @Valid GetFileFingerprintRequest request,
            HttpServletRequest req, HttpServletResponse rsp
    ) {
     ...
     */
    @Override
    public HttpResultResponse folderUploadCallback(
            String workspaceId,
            @Valid FolderUploadCallbackRequest request,
            HttpServletRequest req, HttpServletResponse rsp
    ) {
        return null;
    }
