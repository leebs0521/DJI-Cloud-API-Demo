...
/**
 * MQTT 프로퍼티 설정 토픽 응답 클래스
 * 프로퍼티 설정 응답에 대한 통합된 토픽 응답 형식을 정의하는 제네릭 클래스
 * 
 * @author sean.zhou
 * @date 2021/11/15
 * @version 0.1
...
public class TopicPropertySetResponse<T> extends CommonTopicResponse<T> {
    ...
    /**
     * 프로퍼티 설정 응답 데이터를 반환합니다.
     * @return 프로퍼티 설정 응답 데이터
     */
    public T getData() {
        return data;
    }
    ...
    /**
     * 프로퍼티 설정 응답 데이터를 설정합니다.
     * @param data 프로퍼티 설정 응답 데이터
     * @return 현재 객체 (메서드 체이닝 지원)
     */
