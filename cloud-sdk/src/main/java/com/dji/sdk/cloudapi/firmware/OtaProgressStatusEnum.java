 ...
 * OTA 진행 상태 열거형 클래스
 * 
 * 이 클래스는 DJI Cloud API에서 OTA(Over-The-Air) 펌웨어 업데이트의 진행 상태를 정의합니다.
...
public enum OtaProgressStatusEnum {
    ...
    /**
     * 전송됨
     * OTA 펌웨어 업데이트 요청이 전송된 상태
     */
    SENT("sent", false),

    /**
     * 진행 중
     * OTA 펌웨어 업데이트가 진행 중인 상태
     */
    IN_PROGRESS("in_progress", false),

    /**
     * 성공
     * OTA 펌웨어 업데이트가 성공적으로 완료된 상태
     */
    OK("ok", true),

    /**
     * 일시정지
     * OTA 펌웨어 업데이트가 일시정지된 상태
     */
    PAUSED("paused", false),

    /**
     * 거부됨
     * OTA 펌웨어 업데이트 요청이 거부된 상태
     */
    REJECTED("rejected", true),

    /**
     * 실패
     * OTA 펌웨어 업데이트가 실패한 상태
     */
    FAILED("failed", true),

    /**
     * 취소됨
     * OTA 펌웨어 업데이트가 취소된 상태
     */
    CANCELED("canceled", true),

    /**
     * 타임아웃
     * OTA 펌웨어 업데이트가 타임아웃된 상태
     */
    ...
    /**
     * 문자열로 OTA 진행 상태를 찾습니다.
     * 
     * @param status 찾을 상태 문자열
     * @return 찾은 OTA 진행 상태 열거형
