 ...
 * HMS 배터리 인덱스 열거형 클래스
 * 
 * 이 클래스는 DJI Cloud API에서 HMS(Health Management System) 배터리 관련 인덱스를 정의합니다.
 * 좌측과 우측 배터리를 구분하며, 영어와 중국어로 각각의 위치를 표현합니다.
 * 
 * @author sean
 * @version 1.1
 * @date 2022/7/7
...
public enum HmsBatteryIndexEnum {
    ...
    /**
     * 숫자로 HMS 배터리 인덱스를 찾습니다.
     * 
     * @param val 찾을 배터리 인덱스 값
     * @return 찾은 HMS 배터리 인덱스 열거형
