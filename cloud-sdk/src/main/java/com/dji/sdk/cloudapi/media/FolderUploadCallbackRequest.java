 ...
 * @date 2023/6/19
 */
@Schema(description = "폴더 업로드 콜백 요청 데이터")
public class FolderUploadCallbackRequest {
    ...
    @Schema(description = "파일 그룹 ID", format = "uuid")
    ...
    @Schema(description = "파일 그룹 내 총 미디어 파일 수")
    ...
    @Schema(description = "파일 그룹 내 업로드 완료된 미디어 파일 수")
